...
-- CreateEnum
CREATE TYPE "power_strategy_enum" AS ENUM ('WOL', 'AO', 'SP', 'BPD');
...
-- CreateEnum
CREATE TYPE "wol_flag_enum" AS ENUM ('a', 'b', 'g', 'm', 'p', 's', 'u', 'd');

-- CreateEnum
CREATE TYPE "power_on_device_type_enum" AS ENUM ('SMART_PLUG', 'BUTTON_PRESS');
...
CREATE TABLE "node" (
    ...
    "powerOnStrategy" "power_strategy_enum" NOT NULL,
...
-- CreateTable
CREATE TABLE "power_on_device" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "nodeId" UUID NOT NULL,
    "deviceType" "power_on_device_type_enum" NOT NULL,
    "address" TEXT NOT NULL,

    CONSTRAINT "power_on_device_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "power_on_device_nodeId_key" ON "power_on_device"("nodeId");
...
-- AddForeignKey
ALTER TABLE "power_on_device" ADD CONSTRAINT "power_on_device_nodeId_fkey" FOREIGN KEY ("nodeId") REFERENCES "node"("id") ON DELETE CASCADE ON UPDATE CASCADE;
