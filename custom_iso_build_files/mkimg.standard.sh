...
profile_extended() {
	...
	apks="$apks
		...
		nano wget newt gcc g++ bash automake autoconf coreutils sudo 
		jq yq sysbench inotify-tools postgresql iproute2 procps ethtool 
		docker nodejs make npm util-linux recluster
		"
...
profile_recluster() {
        ...
        title="Recluster"
        desc="Custom profile for reCluster installation."
        arch="aarch64 armv7 x86 x86_64"
	apkovl="aports/scripts/genapkovl-recluster.sh"	
}
